      ...
      <div className="col-span-1  rounded-full">
        {currentStep == 1 ? (
          <div className="relative inline-flex h-2.5 w-full overflow-hidden rounded-full p-[0.5px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <span className="inline-flex h-full w-full items-center justify-center rounded-full bg-salmonlight backdrop-blur-3xl"></span>
          </div>
        ) : (
      ...
      <div className="col-span-1 h-2 rounded-full">
        {currentStep == 2 ? (
          <div className="relative inline-flex h-2.5 w-full overflow-hidden rounded-full p-[0.5px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <span className="inline-flex h-full w-full items-center justify-center rounded-full bg-salmondark  backdrop-blur-3xl"></span>
          </div>
        ) : (
          <div className="h-2 w-full inline-flex rounded-full bg-platinum ring-1 ring-gray-300"></div>
        )}
      </div>
      <div className="col-span-1 h-2 rounded-full">
        {currentStep == 3 ? (
