      ...
      <div className="  gap-2 items-center">
        <Label
          ...
          className="flex group group-hover:before:duration-500  duration-500 before:duration-500 hover:duration-500 underline underline-offset-2 hover:after:-right-8 hover:before:right-12 hover:before:-bottom-8 hover:before:blur hover:underline hover:underline-offset-4
           origin-left hover:decoration-2 hover:text-rose-50 relative bg-slate-600  w-full border text-left  text-stone-200 gap-2 p-3  text-base font-bold rounded-full  overflow-hidden  before:absolute before:w-12 before:h-12 before:content[' '] before:right-1 before:top-1 "
        >
          <Input
            {...register('image')}
