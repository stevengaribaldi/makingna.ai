    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `flex h-10 field-input w-full border-none  text-black font-semibold dark:text-white shadow-input rounded-md px-8 py-2 text-sm file:border-0 file:bg-transparent
