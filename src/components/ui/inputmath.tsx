    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `flex h-10 field-input w-full border-none bg-white text-black font-semibold dark:text-white shadow-input rounded-md px-8 py-2 text-sm file:border-0 file:bg-transparent
          ...
          disabled:cursor-not-allowed disabled:opacity-50 dark:shadow-[0px_0px_1px_1px_var(--neutral-700)] feild
